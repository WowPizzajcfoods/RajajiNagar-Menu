    ...
    <footer className="flex flex-col">
      ...
      <div className="flex flex-col-reverse items-center justify-center border-t border-[#cdcdcd] py-3 gap-2">
        ...
        <div className="flex justify-center gap-3">
          <a href={`https://zomato.onelink.me/xqzv/fa0ixh4c`}>
            <div className="relative w-9 h-9 md:w-10 md:h-10 border border-[#D94148] rounded bg-[#D94148] shadow-md md:transition-all md:duration-400 md:hover:bg-[#D94148] md:hover:scale-110">
              <ImageWithLoading
                alt={`Call`}
          ...
          <a href={`https://www.swiggy.com/menu/1252657?source=sharing`}>
            <div className="relative w-9 h-9 md:w-10 md:h-10 border border-[#fe5105] rounded bg-[#fe5105] shadow-md md:transition-all md:duration-400 md:hover:bg-[#fe5105] md:hover:scale-110">
              <ImageWithLoading
                alt={`Call`}
